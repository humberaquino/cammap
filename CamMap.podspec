#
#  Be sure to run `pod spec lint CamMap.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Humberto Aquino" => "humberaquino@gmail.com" }
  # Or just: s.author    = "Humber Aquino"
  # s.authors            = { "Humber Aquino" => "humberaquino@gmail.com" }
  s.social_media_url   = "http://twitter.com/goku2"
